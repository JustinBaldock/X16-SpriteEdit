...
32050 IF CB%(X,Y)=0 THEN VPOKE 0,$0102+(X*2)+(Y*256),32 : T=0
...
35210 NU=0: REM **OVERWRITES** CONTENTS OF NU
...
35820 POKE 781,8: POKE 782,32:POKE 783,0: SYS $FFF0
35830 PRINT "%"T" ";
35840 RETURN
...
36120 NEXT I
36130 CLOSE 8
36140 GOSUB 35900: REM CLEAR FILE ACCESS BOX
36150 GOSUB 2000: REM MANAGE UI SELECTION
36160 RETURN
...
38140 NEXT I
38150 CLOSE 8
38160 GOSUB 35900: REM CLEAR FILE ACCESS BOX
38170 GOSUB 2000: REM MANAGE UI SELECTION
38180 RETURN

40000 REM SETUP GRAPHICS
40010 SCREEN ($00): REM 40X30 SCREEN MODE
40020 COLOR 1,0: CLS
40040 PRINT "SETUP OF PROGRAM IS SLOW DUE TO BASIC."
40041 PRINT "WHEN SAVING OR LOADING A FILE YOU ARE"
40042 PRINT "LIMITED TO 11 CHARARCTERS."
40043 PRINT ".CHAR IS AUTO APPENDED TO FILENAME."
40050 GOSUB 42000: REM SETUP LAYER 0 - CUSTOM FONT-SET
40060 GOSUB 41000: REM SETUP LAYER 1 - UI
40070 GOSUB 43000: REM SETUP CURSOR SPRITE
40080 GOSUB 44000: REM DRAW PALETTE
40090 POKE $9F29,%01110001: REM SET LAYER 0, LAYER 1 AND SPRITES ACTIVE
40100 RETURN

...
2430 GOSUB 23000: REM GET CHAR BITS
2440 GOSUB 32000: REM DISPLAY CHAR BITS ARRAY
2450 RETURN
...
32010 FOR Y = 0 TO 7
32020 FOR X = 0 TO 7
32030 IF CB%(X,Y)=1 THEN VPOKE 0,$0102+(X*2)+(Y*256),160
32040 IF CB%(X,Y)=0 THEN VPOKE 0,$0102+(X*2)+(Y*256),32
32050 NEXT X
32060 NEXT Y
32070 RETURN
...
35210 NU=0: REM REQUIRES VALUE 8-BIT ARRAY BY% AND STORES VALUE IN NU

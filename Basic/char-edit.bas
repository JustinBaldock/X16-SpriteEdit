...
480 IF KP$=CHR$(76) THEN GOSUB 38000: REM L KEY TO LOAD
490 RETURN
...
35820 POKE 781,8: POKE 782,34:POKE 783,0: SYS $FFF0
35830 PRINT "%"T;
35840 RETURN
...
35940 VPOKE 0,$0716+(X*2)+(Y*256)+1,$61
35950 NEXT X
35960 NEXT Y
35970 RETURN
...
42025 FE = 2048: REM SET LIMIT FOR DISPLAY PERCENT
...
42110 VPOKE $0,$4000+(X*2),$20: VPOKE $0,$4000+(X*2)+1,$61
...
60170 LET FC=0: FE=0: REM FILE CURRENT/FILE END USED TO DISPLAY PERCENT OF I/O
60200 :
60500 REM FUNCTIONS 

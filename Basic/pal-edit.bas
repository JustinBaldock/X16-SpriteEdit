...
5050 FO$ = "@0:" + FO$ + ".PAL,S,W"
5060 OPEN 8,8,8,FO$
5070 FOR I=0 TO 511
5075 LET T=VPEEK(1,PR+I)
5080 PRINT#8, T
5090 NEXT I
5095 CLOSE 8
5100 GOSUB 41000
...
6000 CLS
6010 PRINT "ENTER THE FILE NAME,"
6020 PRINT ".PAL WILL BE AUTOMATICALLY ADDED TO IT."
6030 INPUT "FILENAME:"; FI$: REM FI$ = FILE IN
6040 FI$ = FI$ + ".PAL"
6050 OPEN 1,8,2,FI$ :REM LOGICAL FILE 1, FROM DEVICE 8, DATA CHANNEL 2
6060 FOR I=0 TO 511
6065 INPUT#1,T
6070 VPOKE 1,PR+I,T
6080 NEXT I

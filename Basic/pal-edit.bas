10 REM PALETTE EDIT BY JUSTIN BALDOCK 2021
...
3140 IF KP$=CHR$(76) THEN GOTO 6000: REM L KEY TO LOAD
3150 RETURN

3200 REM FUNCTION MOVE CURSOR LEFT
...
3300 REM FUNCTION MOVE CURSOR RIGHT
...
3400 REM FUNCTION MOVE CURSOR DOWN
...
3500 REM FUNCTION MOVE CURSOR UP
...
3600 REM FUNCTION INCREASE R VALUE
3610 R = R+1
...
3700 REM FUNCTION INCREASE G VALUE
3710 G = G+1
...
3800 REM FUNCTION INCREASE B VALUE
3810 B = B+1
...
3900 REM FUNCTION UPDATE PALETTE
...
5000 REM FUNCTION SAVE FILE
5010 CLS
5020 GOSUB 59000: REM TURN OFF GRAPHICS
5030 PRINT "ENTER THE FILE NAME," 
5040 PRINT ".PAL WILL BE ADDED TO IT"
5050 PRINT "EXISTING FILE WILL BE OVERWRITTEN."
5060 INPUT "FILENAME:"; FO$
5070 FO$ = "@0:" + FO$ + ".PAL,S,W"
5080 OPEN 8,8,8,FO$
5090 FOR I=0 TO 511
5100 LET T=VPEEK(1,PR+I)
5110 PRINT#8, T
5120 NEXT I
5130 CLOSE 8
5140 LET DF$=FO$: REM UPDATE DISPLAY FILENAME TO BE THE FILE OUT NAME
5150 GOSUB 40000: REM DRAW MAIN SCREEN
5160 GOSUB 59100: REM TURN ON GRAPHICS
5190 GOTO 1000

6000 REM FUNCTION OPEN AND LOAD FILE
6010 CLS
6020 GOSUB 59000: REM TURN OFF GRAPHICS
6030 PRINT "ENTER THE FILE NAME,"
6040 PRINT ".PAL WILL BE AUTOMATICALLY ADDED TO IT."
6050 INPUT "FILENAME:"; FI$: REM FI$ = FILE IN
6060 FI$ = FI$ + ".PAL"
6070 OPEN 2,8,2,FI$ :REM LOGICAL FILE 2, FROM DEVICE 8, DATA CHANNEL 2
6080 GOSUB 6500: REM GET DRIVE ERRORS
6090 IF ER =0 THEN GOTO 6300: REM NO DISK ERROR, GO PROCESS FILE
6100 IF ER <>0 THEN GOTO 6150: REM DISPLAY ERROR
6150 REM ERROR MESSAGE I/O
6160 PRINT: REM DISPLAY ERROR INFORMAITON
6170 PRINT"I/O ERROR!":PRINT "CODE="ER:PRINT"MESSAGE="EM$
6180 PRINT: PRINT"PRESS SPACE KEY TO CONTINUE."
6190 GET K$: IF K$<>" " THEN GOTO 6190: REM WAIT FOR USER
6200 GOTO 6350: REM CLOSE FILE
6300 REM PROCESS FILE
6310 FOR I=0 TO 511
6320 INPUT#2,T
6330 VPOKE 1,PR+I,T
6340 NEXT I
6350 REM CLOSE FILE AND RETURN TO MAIN SCREEN
6360 CLOSE 2
6370 LET DF$ = FI$: REM UPDATE DISPLAY FILENAME TO BE THE FILE IN NAME
6380 GOSUB 40000: REM DRAW MAIN SCREEN
6390 GOSUB 59100: REM TURN ON GRAPHICS
6400 GOTO 1000: REM SUCCESSFULLY EXIT FUNCTION
 
6500 REM FUNCTION GET ANY ERROR CODES OF LAST DISK OPERATION
6510 OPEN 15,8,15: REM ASSUMING DRIVE IS 8
6520 REM GET ERROR CODE, ERROR MESSAGE, TRACK, SECTOR
6530 INPUT#15,ER,EM$,T,S
6540 CLOSE 15
6550 RETURN

7000 LET CX=1: LET CY=1: REM PALETTE CURSOR LOCATION
7010 REM R = CURRENT PALETTE COLOUR RED VALUE
7020 REM GB = CURRENT PALETTE COLOUR GREEN AND BLUE VALUE
7030 REM G = CURRENT PALETTE COLOUR GREEN VALUE
7040 REM B = CURRENT PALLETTE COLOUR BLUE VALUE
7050 LET PC=0: REM PALETTE COLOUR SELECTION
7060 LET FO$="": REM FO$ = FILE OUT
7070 LET FI$="": REM FI$ = FILE IN
7071 LET DF$="BUILT IN DEFAULTS": REM STRING TO DISPLAY ON SCREEN
7075 LET PR=$FA00: REM VERA PALETTE RAM ADDRESS
7080 REM 30000 - LOADING
7090 REM 40000 - HELP SCREEN
7100 SCREEN$80 :REM 40X30 SCREEN MODE
7110 GOSUB 57000: REM DEFAULT PALETTE TO VERA VRAM
7120 RECT 0,0,319,199,0: REM BLANK SCREEN
7130 GOSUB 40000
7140 GOTO 1000
7150 END
...
40030 GOSUB 54500: REM UPDATE FILENAME
40040 RETURN
...
54000 REM DISPLAY CURRENT SELECTED COLOUR VALUES 
...
54500 REM DISPLAY CURRENT FILE LOADED
54510 RECT 85,190,224,180,0: REM BLACK OUT PREVIOUS FILE NAME
54520 CHAR 85,190,1,DF$: REM DISPLAY FILENAME
54530 RETURN
...
59000 REM TURN OFF GRAPHICS
59010 POKE $9F29, %00100001
59020 RETURN

59100 REM TURN ON GRAPHICS
59110 POKE $9F29, %00110001
59120 RETURN
...
60020 DATA $C3,$0F,$10,$02,$30,$04,$40,$06,$60,$08,$80,$0A,$90,$0C,$B0,$0F

...
6080 REM GOSUB 6500: REM GET DRIVE ERRORS
6090 IF ST =0 THEN GOTO 6300: REM NO DISK ERROR, GO PROCESS FILE
6100 IF ST <>0 THEN GOTO 6150: REM DISPLAY ERROR
6150 REM ERROR MESSAGE I/O
6160 PRINT"I/O ERROR! PRESS ANY KEY."
6170 GET T$: IF T$="" THEN GOTO 6170

...
5000 CLS
5010 GOSUB 59000: REM TURN OFF GRAPHICS
5020 PRINT "ENTER THE FILE NAME," 
5030 PRINT ".PAL WILL BE ADDED TO IT"
5040 PRINT "EXISTING FILE WILL BE OVERWRITTEN."
5050 INPUT "FILENAME:"; FO$
5060 FO$ = "@0:" + FO$ + ".PAL,S,W"
5070 OPEN 8,8,8,FO$
5080 FOR I=0 TO 511
5090 LET T=VPEEK(1,PR+I)
5100 PRINT#8, T
5110 NEXT I
5120 CLOSE 8
5130 GOSUB 41000
5140 GOSUB 50000
5150 GOSUB 59100: REM TURN ON GRAPHICS
5154 LET DF$=FO$: REM UPDATE DISPLAY FILENAME TO BE THE FILE OUT NAME
5155 GOSUB 54500: REM UPDATE FILENAME
5160 GOTO 1000

6000 CLS
6010 GOSUB 59000: REM TURN OFF GRAPHICS
6020 PRINT "ENTER THE FILE NAME,"
6030 PRINT ".PAL WILL BE AUTOMATICALLY ADDED TO IT."
6040 INPUT "FILENAME:"; FI$: REM FI$ = FILE IN
6050 FI$ = FI$ + ".PAL"
6060 OPEN 1,8,2,FI$ :REM LOGICAL FILE 1, FROM DEVICE 8, DATA CHANNEL 2
6070 FOR I=0 TO 511
6080 INPUT#1,T
6090 VPOKE 1,PR+I,T
6100 NEXT I
...
6120 GOSUB 41000
6130 GOSUB 50000
6140 GOSUB 59100: REM TURN ON GRAPHICS
6144 LET DF$ = FI$: REM UPDATE DISPLAY FILENAME TO BE THE FILE IN NAME
6145 GOSUB 54500: REM UPDATE FILENAME
6150 GOTO 1000

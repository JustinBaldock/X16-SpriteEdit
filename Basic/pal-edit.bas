...
5120 NEXT I
5130 CLOSE 8
5140 GOSUB 41000: REM DRAW MAIN SCREEN
5150 REM GOSUB 50000: REM DRAW PALETTE
5160 GOSUB 59100: REM TURN ON GRAPHICS
5170 LET DF$=FO$: REM UPDATE DISPLAY FILENAME TO BE THE FILE OUT NAME
5180 GOSUB 54500: REM UPDATE FILENAME
5190 GOTO 1000
...
6162 PRINT"I/O ERROR!":PRINT "CODE="ER:PRINT"MESSAGE="EM$
6165 PRINT: PRINT"PRESS SPACE KEY TO CONTINUE."
6170 GET K$: IF K$<>" " THEN GOTO 6170: REM WAIT FOR USER
6180 GOTO 6350: REM CLOSE FILE
...
6355 CLOSE 2
6360 GOSUB 41000: REM DRAW MAIN SCREEN
6370 GOSUB 50000: REM DRAW PALETTE
6380 GOSUB 59100: REM TURN ON GRAPHICS
6390 LET DF$ = FI$: REM UPDATE DISPLAY FILENAME TO BE THE FILE IN NAME
6400 GOSUB 54500: REM UPDATE FILENAME
6410 GOTO 1000: REM SUCCESSFULLY EXIT FUNCTION
...
40025 GOSUB 54500: REM UPDATE FILENAME
40030 REM 
40040 RETURN

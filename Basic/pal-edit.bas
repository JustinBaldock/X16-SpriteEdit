...
2000 LET CX=1: LET CY=1: REM PALETTE CURSOR LOCATION
2010 REM R = CURRENT PALETTE COLOUR RED VALUE
2020 REM GB = CURRENT PALETTE COLOUR GREEN AND BLUE VALUE
2030 REM G = CURRENT PALETTE COLOUR GREEN VALUE
2040 REM B = CURRENT PALLETTE COLOUR BLUE VALUE
2050 LET PC=0: REM PALETTE COLOUR SELECTION
2060 LET FO$="": REM FO$ = FILE OUT
2070 LET FI$="": REM FI$ = FILE IN
2075 LET PR=$FA00: REM VERA PALETTE RAM ADDRESS
2080 REM 30000 - LOADING
2090 REM 40000 - HELP SCREEN
2100 SCREEN$80 :REM 40X30 SCREEN MODE
2110 GOSUB 57000: REM DEFAULT PALETTE TO VERA VRAM
2120 RECT 0,0,319,199,0: REM BLANK SCREEN
2130 GOSUB 40000
2140 GOTO 1000
2150 END
